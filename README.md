...
3)create a html page with following UI characteristics:
- background is gradient with red-blue changing from time to time frpm blue to red and vice-versa (the change was horizontally fade-in)
- there is a vertical angelic-white glowing line with smooth edges from top to bottom. The ends of the line were very smooth and fading away with glow
- on the left side of line, there was "Power" written in white colour with a glow and from top of the page, it was 1 finger distance bottom
- on the right side of the line, there was "Connection" written in red colour with same glow and from top of the page, it was 1 finger distance bottom
- on the line,  3 cms from bottom, "Story" was wriitten in blue colour such that the line cuts the word from center and the word "Story" was appearing letter-by-letter and fading away
